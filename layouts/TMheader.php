    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0;" >
                ...
                <div style="float:left ;top:0%;right:15%;width: 70%">
                    <?php
                ...
                <ul class="nav navbar-right top-nav">
                    <li class="dropdown">
                        <img src="images/foresight.png" class="hidden-xs" width="160px" height="60px" >
                ...
                <div class="navbar-default sidebar" role="navigation" >
                    <div class="sidebar-nav navbar-collapse" >
                        ...
                        <ul class="nav" id="side-menu">
                            ...
                            <li>
                                <a href="#"><i class="fa fa-file-archive-o "></i> Manage Doctor Profiles<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-archive "></i> Product Priority<span class="fa arrow"></span></a>
                                <ul class="nav nav-second-level">
                                    <li>
                            ...
                            <li>
                                ...
                                <ul class="nav nav-second-level">
                                    <li>
                                        ...
                                        <ul class="nav nav-third-level">
                                            <li>
                                                <a href="Daily_plan.php">View Planning</a>
                                            </li>
                                            <li>
                                                <a href="visit_report.php">Missed Doctor List</a>
                                            </li>
                                        </ul>
                                        <!-- /.nav-third-level -->
                                    </li> 
