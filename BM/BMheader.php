...
<!DOCTYPE html>
<html lang="en">
<?php $empName = BM::find_by_bmid($_SESSION['BM']); ?>
    <head>
        ...
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="BMindex.php"><img src="../images/Logo.png" width="150px" height="100px" ></a>
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        ...
                        <ul class="nav" id="side-menu">
                            <li>
                                <a class="active" href="BMindex.php"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a>
                            </li>

                            <li>
                                <a href="viewTeam.php"><i class="fa fa-group"></i> Your Team</a>
                            </li>

                            <li>
                                <a href="viewAllDoctorsProfile.php"><i class="fa fa-list-alt"></i> View All Profiles</a>
                            </li>
                            <li>
