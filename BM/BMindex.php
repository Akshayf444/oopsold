...
$empName = BM::find_by_bmid($_SESSION['BM']);
...
foreach ($DoctorClass as $value) {
    $class = $value;
    $Count = BasicProfile::BMdrawPieChart($bm_empid, $class);
...
$service = 'Yes';
$Count = Services::BMdrawPieChart($bm_empid, strtolower($service));
...
foreach ($total as $value) {
    $Count = BusiProfile::BMdrawBarGraph($bm_empid, $value);
    $myurl3[] = $Count;
}
...
<div class="row">
    ...
    <div class="col-lg-3 col-md-6">
        <div class="panel panel-green">
            ...
            <a href="viewAllDoctorsProfile.php">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge"><?php echo Doctor::profileCount_bmwise($bm_empid) ?></div>
                        <div>Profiles Completed </div>
                    </div>
                </div>
            </div>
            <a href="viewAllDoctorsProfile.php?complete=true">
                <div class="panel-footer">
                    <span class="pull-left">View Details</span>
                    <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                    <div class="clearfix"></div>
        ...
        <div class="panel panel-red">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge"><?php
                            $Activity = Activity::count_by_bm_empid($bm_empid);
                            echo $Activity;
                            ?></div>
