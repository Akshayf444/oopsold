...
$empcount = zone::count_all($zone_id);
$employees = zone::find_all_tm($zone_id);

$doctorCount = zone::count_all_doctors($zone_id);

$totalCount = zone::totalProfileCount($zone_id);
$DoctorClass = array('A', 'B', 'A++', 'A+', 'Z');
foreach ($DoctorClass as $value) {
    $class = $value;
    $Count = zone::BMdrawPieChart($zone_id, $class);
...
$service = 'Yes';
$Count = zone::BMdrawPieChart2($zone_id, strtolower($service));
...
foreach ($total as $value) {
    $Count = zone::BMdrawBarGraph($zone_id, $value);
    $myurl3[] = $Count;
}
//Monthwise Business
$xAxisData = array();
...
for ($i = 1; $i <= 12; $i++) {
    ...
    $brand_busi_list = 0;
        ...
        $brand_busi_list += zone::Month_wise_Buisness($month, $zone_id);
        ...
        <div class="panel panel-yellow">
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-xs-9 text-right">
                        <div class="huge"><?php echo Doctor::profileCount_bmwise($zone_id) ?></div>
...
for ($i = 1; $i <= 12; $i++) {
    ...
    $activityCount = 0;
        ...
        $activityCount += zone::count_for_month($zone_id, $month);
