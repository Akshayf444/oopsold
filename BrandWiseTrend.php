...
if (isset($brandSeriesData)) {
    echo json_encode($brandSeriesData);
} elseif (isset($brandSeriesData2)) {
    echo json_encode($brandSeriesData2);
} else {
